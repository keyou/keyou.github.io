...
[![perfetto-tracing](/data/perfetto-tracing.svg)](/data/perfetto-tracing.svg)
...
![TraceViewer](/data/2020-05-22-17-09-02.png)

完整的 Trace 格式介绍见： <https://docs.google.com/document/d/1CvAClvFfyA5R-PhYUmn5OOQtYMH4h6I0nSsKchNAySU/edit#>

从图中可看到代码段的调用耗时，包括CPU耗时和Wall耗时。
关于这些时间的计算方法和区别可以参考 [关于代码的执行时间]({% post_url 2020-05-16-time %})。
